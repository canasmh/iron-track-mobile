...
void main() {
  group('SocialLoginSection', () {
    ...
    testWidgets('renders divider with correct text',
    ...
    testWidgets('renders all social buttons with correct icons',
      ...
      expect(
        find.byWidgetPredicate((widget) =>
            widget is FaIcon && widget.icon == FontAwesomeIcons.facebook),
        findsOneWidget,
      );
      expect(
        find.byWidgetPredicate((widget) =>
            widget is FaIcon && widget.icon == FontAwesomeIcons.xTwitter),
        findsOneWidget,
      );
      expect(
        find.byWidgetPredicate((widget) =>
            widget is FaIcon && widget.icon == FontAwesomeIcons.google),
        findsOneWidget,
      );
      expect(
        find.byWidgetPredicate((widget) =>
            widget is FaIcon && widget.icon == FontAwesomeIcons.apple),
        findsOneWidget,
      );
    });
